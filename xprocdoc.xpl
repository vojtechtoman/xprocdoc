<p:declare-step version="1.0"
  ...
  <p:pipeline type="xd:process-source" name="process-source">
    <p:input port="summary"/>
  ...
  <p:pipeline type="xd:process-library-as-source" name="process-library-as-source">
    <p:input port="summary"/>
  ...
  <p:pipeline type="xd:process-import" name="process-import">
    <p:input port="summary"/>
    <p:output port="result-summary">
      <p:pipe step="choose" port="result-summary"/>
    </p:output>
  ...
  <p:pipeline type="xd:process-step-as-source" name="process-step-as-source">
    <p:input port="summary"/>
    <p:option name="standalone" select="'false'"/>
  ...
  <p:pipeline type="xd:process-port" name="process-port">
  ...
  <p:pipeline type="xd:process-option" name="process-option">
    <p:input port="context-source"/>
  ...
  <p:pipeline type="xd:process-documentation" name="process-doc">
    <!-- source: where to extract documentation from -->
